  ...
  return (
    <div> 
      ...
      <div className="w-[90%] flex flex-row mx-auto my-10 gap-10 justify-evenly">
        <img src={allContent ? allContent[0]?.thumbnail : null} alt="" className="w-[50%] rounded-lg" />
        <div className="flex flex-col w-[30%] relative py-8">
            ...
            <h1 className="my-4 font-bold font-edu-sa mx-2 text-2xl" >{allContent ? allContent[0]?.title : null}</h1>
            <p className="text-richblack-400 mx-2 text-lg">{allContent ? allContent[0]?.description : null}</p>
            <h2 className="my-3 text-richblack-500 font-semibold mx-2">{allContent ? allContent[0]?.date.split('T')[0]  : null}</h2>
